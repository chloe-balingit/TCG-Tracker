            ...
            if len(set_cards_today) < len(set_cards_before):
                while i != len(set_cards_before):
                    if i < len(set_cards_today):
                        if ((set_cards_before.iloc[i].loc['card_id'] == set_cards_today.iloc[i].loc['card_id']) and 
                            (set_cards_before.iloc[i].loc['card_version'] == set_cards_today.iloc[i].loc['card_version'])):
