...
while response.status_code != 200:
  print("Lorcana API : Connection Error -- " + str(response))
  response = requests.get(url, headers=headers)
data = response.json()
print("Lorcana API : Connection Successful! -- " + str(response))
...
for set in data['results']:
    ...
    response = requests.get(url)
    while response.status_code != 200:
      print(str(set_name) + ": Connection Error -- " + str(response))
      response = requests.get(url, headers=headers)
    data = response.json()
    print(str(set_name) + ": Connection Successful! -- " + str(response))
...
# print(str(response))
while response.status_code != 200:
  print("One Piece API Sets: Connection Error -- " + str(response))
  response = requests.get(url, headers=headers)
data = response.json()
print("One Piece API Sets: Connection Successful! -- " + str(response))
...
for set in data:
    ...
    data_set_name = set['set_name']

    url = "https://optcgapi.com/api/sets/" + data_set_id + "/"
    response = requests.get(url)
    while response.status_code != 200:
      print(str(data_set_name) + ": Connection Error -- " + str(response))
      response = requests.get(url, headers=headers)
    data = response.json()
    print(str(data_set_name) + ": Connection Successful! -- " + str(response))
...
for deck in data:
    ...
    data_deck_name = deck['structure_deck_name']

    url = "https://optcgapi.com/api/decks/" + data_deck_id + "/"
    response = requests.get(url)
    while response.status_code != 200:
      print(str(data_deck_name) + ": Connection Error -- " + str(response))
      response = requests.get(url, headers=headers)
    data = response.json()
    print(str(data_deck_name) + ": Connection Successful! -- " + str(response))
...
# # PUSHING STUFF TO HUGGINGFACE GIT
